...
index_of_query_image = 3        # Should be in the range 2..6 inclusive
...
def main():
    ...
    for id1, kp1 in enumerate(keypoints1):
        ...
        cv2.imshow("Image {}".format(index_of_query_image), bgr_display2)

        cv2.waitKey(10)

    print("True Positives {} False Positives {}".format(true_positives, false_positives))
    recal = true_positives / actual_positives
    precision = true_positives / (true_positives + false_positives)
    print("Ratio = {}:, Recall = {}, precision = {}".format(ratio_match_dist, recal, precision))
    print("All done, bye!")
